...
(function () {
    ...
    window.addEventListener("mousedown", function (evt) { if (!touching) generateMouseProxyIfRegistered(evt, "pointerdown", true); });
    window.addEventListener("mousemove", function (evt) { if (!touching) generateMouseProxyIfRegistered(evt, "pointermove", true); });
    window.addEventListener("mouseup", function (evt) { if (!touching) generateMouseProxyIfRegistered(evt, "pointerup", true); });
